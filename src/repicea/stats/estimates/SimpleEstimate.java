 ...
 */
public class SimpleEstimate<N extends Number> extends Estimate<N, UnknownDistribution<N>> implements CentralMomentsSettable<N>, Serializable {
	...
	public SimpleEstimate() {
		super(new UnknownDistribution<N>());
