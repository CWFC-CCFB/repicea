...
/**
 * The LogGaussianModel class makes it possible to fit a log-Gaussian distribution to a list of values.<br>
 * <br>
...
public class LogGaussianModel extends AbstractStatisticalModel implements MaximumLikelihoodCompatibleModel {
	 ...
	 */
	public LogGaussianModel(List<Double> values, Matrix startingValues) {
		super();
	 ...
	 * @param values a sample of the distribution
	 */
	public LogGaussianModel(List<Double> values) {
		this(values, null);
	}
