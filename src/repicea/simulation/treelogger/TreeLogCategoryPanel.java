...
public abstract class TreeLogCategoryPanel<T extends TreeLogCategory> extends REpiceaPanel implements CaretListener {
	 ...
	 */
	protected TreeLogCategoryPanel(T logCategory) {
		super();
