...
class MemorizedArray extends ArrayList<XmlList> {

//	private MemorizerWorker backupWorker;
//	private final ArrayList<XmlList> backupList;
...
//		backupList = new ArrayList<XmlList>();
...
//	}
	...
	@Override
	public void add(int index, XmlList mp) {
//		lockMemorizerArray();
		super.add(index, mp);
...
//	@Override
//	public XmlList get(int index) {
////		lockMemorizerArray();
//		XmlList toBeRetrieve = super.get(index);		// avoid writing the new clone over the former one before it is sent back to the Memorizable instance
