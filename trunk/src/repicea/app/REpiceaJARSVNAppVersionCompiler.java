...
public class REpiceaJARSVNAppVersionCompiler extends AbstractAppVersionCompiler {
	...
	private static final String APP_URL = "http://svn.code.sf.net/p/repiceasource/svn/trunk";
	private static String Version_Filename = ObjectUtility.getPackagePath(REpiceaJARSVNAppVersionCompiler.class) + REpiceaJARSVNAppVersion.ShortFilename;
