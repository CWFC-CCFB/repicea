...
public class GeneralTipDialog extends GenericShowHTMLDialog implements ActionListener {
	 ...
	 * @param updateHtmlPath the file that contains the update
	 * @param title a String that defines the title of this dialog
	 * @throws IOException if the html file cannot be read
	 */
	public GeneralTipDialog(Window parent, String updateHtmlPath, String title) throws IOException {
		super(parent, updateHtmlPath);
		this.title = title;
		initUI();
	}
	...
	protected void initUI(){
		...
		getContentPane().add(getHTMLFileInAScrollPane(), BorderLayout.CENTER);
	...
	public static void main(String[] args) throws IOException {
		String htmlFile = "D:" + File.separator +
				...
				"sybilleTip_fr.html";
		JDialog dlg = null;
		GeneralTipDialog glw = new GeneralTipDialog(dlg, htmlFile, REpiceaTranslator.getString(MessageID.TipTitle));
		glw.setVisible(true);
