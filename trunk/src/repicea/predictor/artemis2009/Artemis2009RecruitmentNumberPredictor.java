...
public class Artemis2009RecruitmentNumberPredictor extends ModelBasedSimulator {
	 ...
	 */
	public Artemis2009RecruitmentNumberPredictor(boolean isParametersVariabilityEnabled, boolean isResidualVariabilityEnabled) {
