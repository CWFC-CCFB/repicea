...
public class TestRecordReader extends REpiceaRecordReader {
	...
	private static List<ImportFieldElement> defineFields() throws Exception {
		...
		importFields.add(new ImportFieldElement(FieldID.PLOT,
												...
												FieldType.String));
		importFields.add(new ImportFieldElement(FieldID.LATITUDE,
												MessageID.DescPlotYCoord.toString (),
												"capsis.quebecmrnf.field.plotycoord",
												false,
												MessageID.HelpPlotYCoord.toString (),
												FieldType.Double));
		importFields.add(new ImportFieldElement(FieldID.LONGITUDE,
												MessageID.DescPlotXCoord.toString (),
												"capsis.quebecmrnf.field.plotxcoord",
												false,
												MessageID.HelpPlotXCoord.toString (),
												FieldType.Double));
		importFields.add(new ImportFieldElement(FieldID.ALTITUDE,
												MessageID.DescPlotAltitude.toString (),
												"capsis.quebecmrnf.field.plotaltitude",
												false,
												MessageID.HelpPlotAltitude.toString (),
												FieldType.Double));
		importFields.add(new ImportFieldElement(FieldID.ECOREGION,
												MessageID.DescPlotEcoRegion.toString (),
												"capsis.quebecmrnf.field.plotecoregion",
												false,
												MessageID.HelpPlotEcoRegion.toString (),
												FieldType.String));
		importFields.add(new ImportFieldElement(FieldID.TYPEECO,
												MessageID.DescPlotTypeEco.toString (),
												"capsis.quebecmrnf.field.plottypeeco",
												false,
												MessageID.HelpPlotTypeEco.toString (),
												FieldType.String));
		importFields.add(new ImportFieldElement(	FieldID.DRAINAGE_CLASS,
				MessageID.DescPlotDrainClass.toString(),
				"capsis.artemis.field.plotdrainclass",
				false,
				MessageID.HelpPlotDrainClass.toString(),
				FieldType.String));
		importFields.add(new ImportFieldElement(	FieldID.PLOTWEIGHT,
				MessageID.DescWeight.toString(),
				"capsis.artemis.field.weight",
				true,
				MessageID.helpPlotWeight.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement(	FieldID.PRECTOT,
				MessageID.DescPlotTotalPrec.toString(),
				"capsis.artemis.field.plottotalprec",
				true,
				MessageID.HelpTotalPrec.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement(	FieldID.MEANTEMP,
				MessageID.DescPlotMeanTemp.toString(),
				"capsis.artemis.field.plotaveragetemp",
				true,
				MessageID.HelpPlotMeanTemp.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement(	FieldID.SPECIES,
				...
				FieldType.String));
		importFields.add(new ImportFieldElement(	FieldID.TREESTATUS,
				MessageID.DescTreeStatus.toString(),
				"capsis.artemis.field.treestate",
				false,
				MessageID.HelpTreeStatus.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement(	FieldID.TREEDHPCM,
				MessageID.DescTreeDBH.toString(),
				"capsis.artemis.field.treedhpcm",
				false,
				MessageID.HelpTreeDBH.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement( FieldID.TREEFREQ,
				MessageID.DescTreeFreq.toString(),
				"capsis.artemis.field.treefreq",
				false,
				MessageID.HelpTreeFreq.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement(	FieldID.TREEHEIGHT,
				MessageID.DescTreeHeight.toString(),
				"capsis.artemis.field.treeheight",
				true,
				MessageID.HelpTreeHeight.toString(),
				FieldType.Double));
		importFields.add(new ImportFieldElement(	FieldID.TREEVOLUME,
				MessageID.DescTreeVolume.toString(),
				"capsis.artemis.field.treevolume",
				true,
				MessageID.HelpTreeVolume.toString(),
				FieldType.Double));
		return importFields;
	}
	...
	private static void setLookAndFeel () {
		...
		try {
			UIManager.setLookAndFeel("TonicLookAndFeel");
