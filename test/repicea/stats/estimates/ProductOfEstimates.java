...
public class ProductOfEstimates {
	...
	public static void runSimulation(int sampleSize, int nbMaxRealization) throws Exception {
		...
		formatFields.add(new CSVField("MCMean"));
		formatFields.add(new CSVField("MCVariance"));
		formatFields.add(new CSVField("MCCoverage"));
...
//		runSimulation(10, 50000);
		runSimulation(25, 50000);
//		runSimulation(50, 100000);
//		runSimulation(100, 100000);
	}
